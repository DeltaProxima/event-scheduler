...
const Announcements = (props) => {
    ...
    console.log("Announcements",props.event)
    const [announcement, setAnnouncement] = React.useState(props.event.announcement.fixed);
                    ...
                    <Box sx={Modalstyle}>
                        <div className="flex flex-col">
                            ...
                            <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column',marginLeft:'25px',marginTop:'25px',padding:'4px',boxShadow:'gray 0px 1px 5px',borderRadius: '6px',border:'4px solid white'}}>
                                ...
                                <div>
                                    <input type="text" className='rounded-sm w-full' placeholder='Enter Recipients' style={{border:'solid white',borderRadius: '6px',height:'50px',marginTop:'2px',outline:'none'}}/>
                                </div>
                            </div>
                            <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column',marginLeft:'25px',marginTop:'25px',padding:'4px',boxShadow:'gray 0px 1px 5px',borderRadius: '6px',border:'4px solid white',outline:'none'}}>
                            ...
                            <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column',marginLeft:'25px',marginTop:'25px',padding:'4px',boxShadow:'gray 0px 1px 5px',borderRadius: '6px',border:'4px solid white'}}>
                                ...
                                <div>
                                    <textarea className='rounded-sm w-full' placeholder='Enter Text' style={{border:'solid white',borderRadius: '6px',height:'50px',marginTop:'2px',outline:'none'}}/>
                                </div>
                            </div>
                            <div style={{display:'flex',justifyContent:'space-between',flexDirection:'column',marginLeft:'25px',marginTop:'25px',padding:'4px',boxShadow:'gray 0px 1px 5px',borderRadius: '6px',border:'4px solid white',outline:'none'}}>
